...
<div class="form-group">
	 ...
	 <button id="excel" class="btn  btn-fill btn-success" style="float:right;margin-top:25px">Export To Excel</button>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
					 <button style="float:right;margin-right:20px" type="submit" name="btn_new_party"  onclick="window.location.href='purchase_order.php'" class="btn  btn-fill btn-success" style="float:right;"> New Purchase Order</button>
