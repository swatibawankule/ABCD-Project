...
<div class="wrapper">
  ...
  <script type="text/javascript">
	...
	var prjName= $("#project_name").val();
			 window.location="ProjectWiseProfitLoss.php?projectName="+prjName;		
		});
		});
		</script>
		  ...
		  <div class="content">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-12">
					 <button style="float:right;margin-right:20px" type="submit" name="btn_new_party"  onclick="window.location.href='project.php'" class="btn  btn-fill btn-success" style="float:right;">Add New Project</button>
...
<thead>
							 ...
							 <th align="center">Project Date</th>
							 <th align="center">Customer Name</th>
							 <th align="center">Sale Order Challan No</th>
...
$statement = "`project` ORDER BY `project_sr_no` ASC"; // Change `records` according to your table name.
...
if (mysqli_num_rows($results) != 0) {
    ...
    while ($row = mysqli_fetch_array($results)) {
		echo "<tr>
                                      ...
                                      <td>$row[project_sr_no]</td>
                                      <td>$row[project_name]</td>
									  <td>$row[project_date]</td>
                                      <td>$row[project_po_customer]</td>
                                      <td>$row[project_challan_no]</td> 
                                     
										  
                                      <td><a href=edit_customer.php?project_sr_no=$row[project_sr_no] class='btn btn-fill btn-primary'>Edit</a>
									
									 </a></td>
                                     <td><a href=view_customer.php?project_sr_no=$row[project_sr_no] class='btn btn-fill  btn-info'>View</a>
									</td>
									
									
                                       <td><a style=\"width:70px;padding:5px\" onClick=\"javascript: return confirm('Are you sure you want to delete Customer details');\" class='btn btn-fill btn-warning' href='delete_customer.php?project_sr_no=$row[project_sr_no]'>Delete</a>
									 </td>
									 </a></td>
