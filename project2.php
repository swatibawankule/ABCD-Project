										     ...
										     <label>BILL DATE</label>
										      <input  type="date" name="project_bill_date" id="project_bill_date" 
										        value="" class="form-control"/>
                                         		 	...
                                         		 	<div class="col-md-3">
                                             <div class="form-group">
										     <label>TOTAL SALE ORDER AMOUNT</label>
							  ...
							  <Select name="project_item" class="form-control" id="project_item">
									...
									<option>--Please Select--</option>	
										     ...
										     <label>RAW MATERIAL</label>
										      <input type="text" name="project_item_raw_material" id="project_item_raw_material" 
										        value="" class="form-control"/>
												 </div>
											</div>
											<div class="col-md-2">
                                             <div class="form-group">
										     <label>MATERILA WEIGHT</label>
											...
											<div class="col-md-2">
										     ...
										     <label>AVAILABLE RAW QTY</label>
										      <input readonly=true type="text" name="project_qty_available" id="project_qty_available" 
										        value="" class="form-control"/>
												 </div>
											</div>
        ...
        $("#project_item_raw_material").change(function(){
	      var project_item_raw_material=$("#project_item_raw_material").val();
			...
			var ret_arr=result.split("~_~");
				...
				$("#project_qty_available").val(ret_arr[1]);
