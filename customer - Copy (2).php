...
//alert("iuyu");
	...
	<div class="col-md-3">
		    ...
		    <button onClick="javascript: return confirm('Are you sure you want to save Customer details');" type="submit" name="submit" id="" class="btn btn-success btn-fill" style="float:right;margin-top:20px">SAVE</button>
							  <button onClick="javascript: return confirm('Are you sure you want to save Supplier details');" type="submit" name="submit" id="btn_save_item" class="btn btn-success btn-fill" style="float:right;margin-top:20px">SAVE 1</button>   
							   </div>
   ...
   <script type="text/javascript">
	...
	var supp_pan_no = $("#supp_pan_no").val();
		...
		'&cust_gst_no=' + cust_gst_no + '&cust_pan_no=' + cust_pan_no +'&supplier_name=' + supplier_name + '&supp_address='  + supp_address +
