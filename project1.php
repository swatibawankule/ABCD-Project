       ...
       <div class="content">
		...
		<form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">  
							...
							<div class="row" style="border:1px solid black; padding:20px">
							  ...
							  <Select name="project_item1" class="form-control" id="project_item1">
									...
									<option>--Please Select--</option>
											...
											<div class="col-md-2">
										     ...
										     <label>PRODUCT ITEM</label>
										      <input type="text" name="project_item" id="project_item" 
...
$(document).ready(function() {
    $("#project_item1").click(function()
{
	project_item1
	project_item

    var project_item1= document.getElementById("project_item1").value;
	document.getElementById("project_item").value = project_item1;
